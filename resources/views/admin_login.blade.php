					...
					<form class="form-horizontal" action="{{ url('/admin-dashboard') }}" method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Your Email">
								...
								<input class="input-large span10" name="admin_email" type="text" placeholder="type Email Address..." required="required" />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="admin_password" type="password" placeholder="type password..." required="required" />
							</div>
